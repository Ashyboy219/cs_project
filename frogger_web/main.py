#!/usr/bin/env python3
# Frogger - browser (WASM) build entry point for pygbag.
# This is the async-loop version of frogger.py so it runs in a web canvas.
# Gameplay logic is identical to the desktop version.
...
async def main():
    ...
    # default bundled font - renders reliably in the browser build
